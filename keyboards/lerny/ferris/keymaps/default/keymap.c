...
#define TAB_MEDIA LT(MEDIA, KC_TAB)
...
#define SPC_GAME_NUM LT(GAME_NUM, KC_SPC)
#define ESC_GAME_FUN LT(GAME_FUN, KC_ESC)
...
//      |-------------+-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+-------------+-------------|
                                                                       SPC_NAV,    ESC_MOUSE,         ENT_SYM,     BSPC_NUM
//                                                              |-------------+-------------|  |-------------+-------------|
    ),
...
//                                                              |-------------+-------------|  |-------------+-------------|
    ...
    [NAV] = LAYOUT(
//      |-------------+-------------+-------------+-------------+-------------|                              |-------------+-------------+-------------+-------------+-------------|
              TG(GAME),      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,                                     C(KC_Y),    S(KC_INS),    C(KC_INS),      C(KC_X),      C(KC_Z),
//      |-------------+-------------+-------------+-------------+-------------|                              |-------------+-------------+-------------+-------------+-------------|
               KC_LGUI,      KC_LALT,      KC_LCTL,      KC_LSFT,      XXXXXXX,                                     CW_TOGG,      KC_LEFT,      KC_DOWN,        KC_UP,      KC_RGHT,
//      |-------------+-------------+-------------+-------------+-------------|                              |-------------+-------------+-------------+-------------+-------------|
               XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,                                      KC_INS,      KC_HOME,      KC_PGDN,      KC_PGUP,       KC_END,
//      |-------------+-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+-------------+-------------|
                                                                       XXXXXXX,      QK_BOOT,          KC_ENT,      KC_BSPC
//                                                              |-------------+-------------|  |-------------+-------------|
    ),
...
//      |-------------+-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+-------------+-------------|
                                                                  SPC_GAME_NUM, ESC_GAME_FUN,         XXXXXXX,      XXXXXXX
//                                                              |-------------+-------------|  |-------------+-------------|
    ),

    [GAME_NUM] = LAYOUT(
//      |-------------+-------------+-------------+-------------+-------------|                              |-------------+-------------+-------------+-------------+-------------|
              TG(GAME),         KC_7,         KC_8,         KC_9,         KC_0,                                     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,
//      |-------------+-------------+-------------+-------------+-------------|                              |-------------+-------------+-------------+-------------+-------------|
               XXXXXXX,         KC_4,         KC_5,         KC_6,     KC_MINUS,                                     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,
//      |-------------+-------------+-------------+-------------+-------------|                              |-------------+-------------+-------------+-------------+-------------|
               XXXXXXX,         KC_1,         KC_2,         KC_3,     KC_EQUAL,                                     XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,
//      |-------------+-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+-------------+-------------|
...
const uint16_t PROGMEM co_base_left[]  = {SPC_NAV, ESC_MOUSE, COMBO_END};
